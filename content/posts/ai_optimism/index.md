...
- name: featuredImage
  src: cherries.jpg
title: How to be optimistic about AI
---

*It's easy to be scared about AI.*

*Not about those -- I hesitate too choose a qualifier, lest it sound too mean --
fantasies that AI could grow to take over the world and have nothing more useful
to do than destroy humanity. I wouldn't want it to sound mean because it's not
the fear that deserves to be deconstructed (assuming some people really have
such a fear), -- it's the psychology of those who create it. That psychology has
been dissected brilliantly in a 2016 [talk/text by Maciej
Cegłowski](https://idlewords.com/talks/superintelligence.htm) (in a nutshell: to
exorbitant hybris, add a reckless wish for immortality) -- nothing I could add
to that, so I won't even try. What I mean is, it's easy to be scared about what
people: governments, companies, societies do with AI.*

*The following text was written as an antidote to that fear, as an
antidepressant of sorts; it describes a set of common sense, yet perhaps
illusory, expectations that should be fulfilled for AI to be a **good thing**.*

### AI as a good thing

In lieu of a definition of AI, I'll start from what I *don't* mean. By no means
do I see artificial intelligence as an end in itself, as some people do.
"Building an intelligent machine", as an end in itself, just how can that even
be a dream? Well, perhaps I should not pose that question; as someone who only
ever read a single book of science fiction (Stanisław Lem's *Solaris*, and even
that just because of the film) I'm bound to lack understanding here. As a dream,
why not. But from a thing billions of dollars are spent on each year, we may
want to demand more, namely, that these intelligent machines be good for
humanity: That they serve the health sciences, for example; mitigate or even
counteract (if possible) climate change; decrease inequality and injustice in
the world; or just somehow improve life on earth.

#### AI as a new engineering discipline (M. Jordan)

Instead, I like the views proferred by [Michael
...
would obviously rather discuss content than arbitrary terminology, [envisions a
new engineering discipline](<https://hdsr.mitpress.mit.edu/pub/wot7mkc1>) that
builds on existing knowledge about inference, optimization, computation, and
uncertainty the way that chemical engineering and civil engineering built upon
chemistry and physics, respectively. Supplementing those building blocks (from
mathematics, statistics, computer science), this new discipline includes
guidance from the social sciences and the humanities. (How exactly that's going
to look remains to be discussed in greater detail; and there are additional
disciplines to be added -- last not least, law.)

As Jordan [puts it](<https://hdsr.mitpress.mit.edu/pub/wot7mkc1>),
...
For AI to be safe to use, it
is paramount that people stay aware of what can, and what cannot, at a given
point in time, be accomplished by it -- in other words, to stay vigilant and
keep critical judgment. As Daniel Dennett points out in [From Bacteria to Bach
and
Back](<https://www.penguin.co.uk/books/253/253900/from-bacteria-to-bach-and-back/9780141978048.html>),
this is made easier if AI devices are *not* designed to "act" in a way that
makes them look more authoritative, competent, and all-knowing than they are.
People are already more than happy to attribute intentions and feelings to
non-living entities[^1]; endowing artificial agents (e.g., expert systems in the
form of chatbots) with anthropomorphic features is likely to make humans cede
judgement to them far too easily.
...
formulated by [Jordan](https://hdsr.mitpress.mit.edu/pub/2imtstfu): Create a market joining producers and
...
[^1]: See e.g. Susan Blackmore, [Consciousness. An Introduction](https://global.oup.com/ushe/product/consciousness-9780199739097?cc=de&lang=en&)]
...
[^3]: In traditional, Western societies, probably it is. For a discussion see
    Susan Blackmore, [Consciousness. An Introduction](https://global.oup.com/ushe/product/consciousness-9780199739097?cc=de&lang=en&)]